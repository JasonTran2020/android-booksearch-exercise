...
public class BookDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPublishDate.setText("Publish date: "+book.getPublish_date()+"]");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        miShareAction = (ShareActionProvider) MenuItemCompat.getActionProvider(menu.findItem(R.id.action_share));
